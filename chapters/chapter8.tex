...
对于我们上一章节描述的基于推理的问答系统，它的最大挑战并不是上述的推理过程。推理控制虽然是个难题，但OpenCog中的 “注意力经济分配”（Economic Attention Allocation, ECAN）的机制可以根据Atomspace中的具体知识对推理控制进行动态指导，这在一定程度上解决了推理控制的难题。但更大的挑战是
